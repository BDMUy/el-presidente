...
export const LEGADO: GameEvent[] = [
  ...
  },
  {
    id: 'leg-oferta-fbf',
    kind: 'dilema',
    title: 'TE QUIEREN EN LA FBF',
    text: 'Te ofrecen un cargo en la dirigencia del fútbol boliviano. Es más poder, y es dejar el club a mitad de mandato.',
    requires: { minSeason: 12, minInfluencia: 55, country: ['bolivia'] },
    options: [
      {
        label: 'Aceptar el cargo y seguir en el club',
        hint: 'Los dos sombreros. Nadie va a creer que no hay conflicto.',
  ...
  },
  {
    id: 'leg-oferta-fef',
    kind: 'dilema',
    title: 'TE QUIEREN EN LA FEF',
    text: 'Te ofrecen un cargo en la dirigencia del fútbol ecuatoriano. Es más poder, y es dejar el club a mitad de mandato.',
    requires: { minSeason: 12, minInfluencia: 55, country: ['ecuador'] },
    options: [
      {
        label: 'Aceptar el cargo y seguir en el club',
        hint: 'Los dos sombreros. Nadie va a creer que no hay conflicto.',
  ...
  },
  {
    id: 'leg-oferta-fvf',
    kind: 'dilema',
    title: 'TE QUIEREN EN LA FVF',
    text: 'Te ofrecen un cargo en la dirigencia del fútbol venezolano. Es más poder, y es dejar el club a mitad de mandato.',
    requires: { minSeason: 12, minInfluencia: 55, country: ['venezuela'] },
    options: [
      {
        label: 'Aceptar el cargo y seguir en el club',
        hint: 'Los dos sombreros. Nadie va a creer que no hay conflicto.',
  ...
  },
  {
    id: 'leg-oferta-cbf',
    kind: 'dilema',
    title: 'TE QUIEREN EN LA CBF',
    text: 'Te ofrecen un cargo en la dirigencia del fútbol brasileño. Es más poder, y es dejar el club a mitad de mandato.',
    requires: { minSeason: 12, minInfluencia: 55, country: ['brasil'] },
    options: [
      {
        label: 'Aceptar el cargo y seguir en el club',
        hint: 'Los dos sombreros. Nadie va a creer que no hay conflicto.',
