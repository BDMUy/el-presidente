...
export const CORRUPCION: GameEvent[] = [
  ...
  {
    id: 'cor-inhabilitacion-py',
    kind: 'golpe',
    title: 'PIDEN INHABILITARTE',
    text: 'La APF analiza inhabilitarte para ejercer cargos en el fútbol. No es una condena penal: es peor, porque no necesita juicio y sale la semana que viene.',
    weight: 3,
    requires: { minFlag: { prontuario: 8 }, minSeason: 6, country: ['paraguay'] },
    options: [
      {
        label: 'Aceptar y poner a alguien de confianza',
        hint: 'Salís del cargo y seguís mandando. Eso creés.',
  ...
  {
    id: 'cor-inhabilitacion-bo',
    kind: 'golpe',
    title: 'PIDEN INHABILITARTE',
    text: 'La FBF analiza inhabilitarte para ejercer cargos en el fútbol. No es una condena penal: es peor, porque no necesita juicio y sale la semana que viene.',
    weight: 3,
    requires: { minFlag: { prontuario: 8 }, minSeason: 6, country: ['bolivia'] },
    options: [
      {
        label: 'Aceptar y poner a alguien de confianza',
        hint: 'Salís del cargo y seguís mandando. Eso creés.',
  ...
  {
    id: 'cor-inhabilitacion-ec',
    kind: 'golpe',
    title: 'PIDEN INHABILITARTE',
    text: 'La LigaPro analiza inhabilitarte para ejercer cargos en el fútbol. No es una condena penal: es peor, porque no necesita juicio y sale la semana que viene.',
    weight: 3,
    requires: { minFlag: { prontuario: 8 }, minSeason: 6, country: ['ecuador'] },
    options: [
      {
        label: 'Aceptar y poner a alguien de confianza',
        hint: 'Salís del cargo y seguís mandando. Eso creés.',
  ...
  {
    id: 'cor-inhabilitacion-ve',
    kind: 'golpe',
    title: 'PIDEN INHABILITARTE',
    text: 'La FVF analiza inhabilitarte para ejercer cargos en el fútbol. No es una condena penal: es peor, porque no necesita juicio y sale la semana que viene.',
    weight: 3,
    requires: { minFlag: { prontuario: 8 }, minSeason: 6, country: ['venezuela'] },
    options: [
      {
        label: 'Aceptar y poner a alguien de confianza',
        hint: 'Salís del cargo y seguís mandando. Eso creés.',
  ...
  {
    id: 'cor-inhabilitacion-br',
    kind: 'golpe',
    title: 'PIDEN INHABILITARTE',
    text: 'La CBF analiza inhabilitarte para ejercer cargos en el fútbol. No es una condena penal: es peor, porque no necesita juicio y sale la semana que viene.',
    weight: 3,
    requires: { minFlag: { prontuario: 8 }, minSeason: 6, country: ['brasil'] },
    options: [
      {
        label: 'Aceptar y poner a alguien de confianza',
        hint: 'Salís del cargo y seguís mandando. Eso creés.',
