...
export const COLOR: GameEvent[] = [
  {
    ...
    requires: { league: ['ar-nacional', 'ar-b', 'uy-segunda', 'pe-segunda', 'co-segunda', 'cl-segunda', 'py-segunda', 'bo-segunda', 'ec-segunda'] },
    options: [
      {
  ...
  },
  {
    ...
    requires: { league: ['ar-primera', 'uy-primera', 'pe-primera', 'co-primera', 'cl-primera', 'py-primera', 'bo-primera', 'ec-primera'], minSize: 6 },
    options: [
      {
        label: 'Ir',
