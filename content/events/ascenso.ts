...
const SOLO_ASCENSO = { league: ['ar-nacional', 'ar-b', 'uy-segunda', 'pe-segunda', 'co-segunda', 'cl-segunda', 'py-segunda', 'bo-segunda', 'ec-segunda'] as const };
...
export const ASCENSO: GameEvent[] = [
  ...
  },
  {
    ...
    requires: { league: ['ar-b', 'uy-segunda', 'pe-segunda', 'co-segunda', 'cl-segunda', 'py-segunda', 'bo-segunda', 'ec-segunda'] },
    options: [
      {
