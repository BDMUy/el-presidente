...
describe('determinismo', () => {
  ...
  it('veinte semillas fijas reconstruyen el mismo estado final byte a byte', () => {
    ...
    expect(huellas).toEqual([
      'boca/corta derrota-electoral s4 m1 t2 d0 a0 p645 9162c9c1',
      'canuelas/normal asamblea s3 m1 t0 d2 a0 p0 1cd48d60',
      'utc/larga asamblea s2 m1 t0 d1 a0 p48 1783ae1c',
      'realcundinamarca/llamas asamblea s1 m1 t0 d1 a0 p0 26c1599c',
      'fernandodelamora/corta derrota-electoral s4 m1 t2 d1 a1 p286 6a19b553',
      'bragantino/larga asamblea s6 m2 t2 d2 a0 p112 ed695140',
      'aldosivi/llamas asamblea s1 m1 t0 d1 a0 p0 0793ab69',
      'cali/normal asamblea s2 m1 t0 d1 a0 p24 68dda903',
      'wilstermann/llamas asamblea s7 m2 t4 d2 a1 p233 b4960edb',
      'river/normal asamblea s4 m1 t0 d0 a0 p263 f90067b8',
      'carapegua/normal derrota-electoral s4 m1 t0 d1 a0 p0 0ae1b814',
      'vitoria/llamas asamblea s1 m1 t0 d1 a0 p0 f827d8b1',
      'colegiales/normal asamblea s8 m2 t2 d2 a1 p74 63895f0e',
      'colegiales/larga asamblea s8 m2 t2 d2 a1 p74 9f75ef06',
      'sanmiguel/normal derrota-electoral s8 m2 t1 d1 a1 p326 4178cfd3',
      'sanmiguel/larga derrota-electoral s8 m2 t1 d1 a1 p326 0cde8a8d',
      'usmp/normal asamblea s7 m2 t3 d2 a1 p224 a29f9b52',
      'cerroporteno/larga asamblea s8 m2 t3 d2 a0 p656 39ddc89a',
      'losandes/normal asamblea s6 m2 t2 d2 a2 p212 cd403db1',
      'binacional/larga asamblea s6 m2 t2 d2 a1 p8 a8a47d6a',
    ]);
  });
});
